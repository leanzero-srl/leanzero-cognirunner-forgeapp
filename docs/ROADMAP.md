...
- **P1 — Integration C** (fact-check checkbox). *Smallest MCP integration; proves the single-shot + timeout + delimited-evidence pattern.*
- **P2 — Integration B** (generate-doc + attach). *The marquee differentiator; exercises the upload bridge in a PF.*
- **P3 — Integration A** (research → DocRepository). *After Step-0 confirm of the live web-search research tool's name/return shape.*
