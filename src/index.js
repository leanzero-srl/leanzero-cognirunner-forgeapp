...
const SUPPORTED_MCPS = {
  ...
  docReader: {
    ...
    writeTools: ["create-doc", "create-markdown", "create-excel", "create-pdf", "create-pptx", "detect-format", "list-templates"],
