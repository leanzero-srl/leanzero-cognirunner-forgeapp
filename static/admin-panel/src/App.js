...
const injectStyles = () => {
  ...
  style.textContent = `
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    html[data-color-mode="dark"] .code-pipe-err, html[data-color-mode="dark"] .code-step-failed .code-step-state, html[data-color-mode="dark"] .code-diff-rem, html[data-color-mode="dark"] .code-run-failed { background: #ef4444; }
    ...
    html[data-color-mode="dark"] .code-pipe-goto { background: #f8fafc; color: #0f172a; }
