 ...
 * sibling cards (high z-index, body-level), and always scrolls long lists. It flips above the
 * trigger when there isn't room below, and repositions on scroll/resize while open.
 *
 * Props:
 *   value, onChange(value), options ([{value,label,meta?,type?}] or strings),
