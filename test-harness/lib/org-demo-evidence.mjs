...
const domains={
  ...
  CONTROLS:{name:'Control Assurance',formats:{pdf:18,csv:8,json:8,txt:8,svg:6},kinds:['Control design','Evidence sampling','Exception assessment','Remediation record','Approval brief'],cases:[
    ['Privileged access','COGDEMO','temporary administrative access','the expiry job has no owner after a service handover','assign an accountable service owner and require an expiry timestamp on every grant','standing elevated access','Security Operations',150,6],
